...
```
## [1] "RMP Objective Value and New Lower bound: 0"
```
...
```
## [1] "DSB Objective Value and New Upper bound: 5.6"
```
...
```
## [1] "Value of u: 1.6" "Value of u: 0.2"
```
...
```
## [1] "RMP Objective Value and New Lower bound: 6"
```
